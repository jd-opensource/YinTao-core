...
export const USKeyboardLayout: KeyboardLayout = {
  ...
  // Third row
  ShiftLeft: {
    keyCode: 160, keyCodeWithoutLocation: 16, key: 'Shift', location: 1,
  },
  ...
  ShiftRight: {
    keyCode: 161, keyCodeWithoutLocation: 16, key: 'Shift', location: 2,
  },

  // Last row
  ControlLeft: {
    keyCode: 162, keyCodeWithoutLocation: 17, key: 'Control', location: 1,
  },
  MetaLeft: { keyCode: 91, key: 'Meta', location: 1 },
  AltLeft: {
    keyCode: 164, keyCodeWithoutLocation: 18, key: 'Alt', location: 1,
  },
  Space: { keyCode: 32, key: ' ' },
  AltRight: {
    keyCode: 165, keyCodeWithoutLocation: 18, key: 'Alt', location: 2,
  },
  AltGraph: { keyCode: 225, key: 'AltGraph' },
  MetaRight: { keyCode: 92, key: 'Meta', location: 2 },
  ContextMenu: { keyCode: 93, key: 'ContextMenu' },
  ControlRight: {
    keyCode: 163, keyCodeWithoutLocation: 17, key: 'Control', location: 2,
  },
  ...
  Numpad7: {
    keyCode: 36, shiftKeyCode: 103, key: 'Home', shiftKey: '7', location: 3,
  },
  Numpad8: {
    keyCode: 38, shiftKeyCode: 104, key: 'ArrowUp', shiftKey: '8', location: 3,
  },
  Numpad9: {
    keyCode: 33, shiftKeyCode: 105, key: 'PageUp', shiftKey: '9', location: 3,
  },
  Numpad4: {
    keyCode: 37, shiftKeyCode: 100, key: 'ArrowLeft', shiftKey: '4', location: 3,
  },
  Numpad5: {
    keyCode: 12, shiftKeyCode: 101, key: 'Clear', shiftKey: '5', location: 3,
  },
  Numpad6: {
    keyCode: 39, shiftKeyCode: 102, key: 'ArrowRight', shiftKey: '6', location: 3,
  },
  NumpadAdd: { keyCode: 107, key: '+', location: 3 },
  Numpad1: {
    keyCode: 35, shiftKeyCode: 97, key: 'End', shiftKey: '1', location: 3,
  },
  Numpad2: {
    keyCode: 40, shiftKeyCode: 98, key: 'ArrowDown', shiftKey: '2', location: 3,
  },
  Numpad3: {
    keyCode: 34, shiftKeyCode: 99, key: 'PageDown', shiftKey: '3', location: 3,
  },
  Numpad0: {
    keyCode: 45, shiftKeyCode: 96, key: 'Insert', shiftKey: '0', location: 3,
  },
  NumpadDecimal: {
    keyCode: 46, shiftKeyCode: 110, key: '\u0000', shiftKey: '.', location: 3,
  },
  NumpadEnter: {
    keyCode: 13, key: 'Enter', text: '\r', location: 3,
  },
}
